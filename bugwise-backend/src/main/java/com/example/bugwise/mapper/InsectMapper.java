...
public class InsectMapper {
    ...
    public InsectDTO toDTO(Insect insect){
        ...
        List<QuestionDTO> questionDTOS = insect.getTemplateQuestions() != null
                ? new ArrayList<>(insect.getTemplateQuestions().stream()
        ...
        return new InsectDTO(
                ...
                insect.getInsectOrder() != null ? insect.getInsectOrder().getId() : null,
                ...
                insect.getInsectFamily() != null ? insect.getInsectFamily().getId() : null,
                ...
                insect.getHabitat() != null ? insect.getHabitat().getId() : null,
