...
import { 
  ...
  MessageSquare, LogOut, Lock, CheckCircle2, ArrowLeft 
} from "lucide-react";
    ...
    <div className="flex min-h-screen hero-pattern text-zinc-100 font-sans">
      ...
      <main className="flex-grow p-12 overflow-y-auto">
        <div className="max-w-2xl mx-auto">
          ...
          <Button variant="ghost" className="mb-6 text-zinc-500 hover:text-lime-500 gap-2 p-0 h-auto">
          ...
          <div className="flex items-center gap-6 mb-10 bg-zinc-900/20 p-6 rounded-3xl border border-zinc-800/50">
            <div className="w-20 h-20 rounded-full bg-lime-500 flex items-center justify-center text-black text-2xl font-black shadow-lg">
              <User size={32} />
            </div>
            <div>
              <h1 className="text-3xl font-black text-white italic tracking-tight">Zmiana Nazwy</h1>
              <p className="text-zinc-500 text-sm">Wybierz swój nowy unikalny identyfikator.</p>
            </div>
          </div>
          ...
          <div className="bg-zinc-900/40 backdrop-blur-md border border-zinc-800 p-10 rounded-[2.5rem] shadow-2xl space-y-8">
            ...
            <div className="space-y-3">
              <Label className="text-zinc-400 ml-1 flex items-center gap-2 uppercase text-xs font-black tracking-widest">
                <Lock size={14} className="text-lime-500" /> Weryfikacja Hasłem
              </Label>
              <Input 
                type="password" 
            ...
            <div className="space-y-3">
              <Label className="text-zinc-400 ml-1 flex items-center gap-2 uppercase text-xs font-black tracking-widest">
                <User size={14} className="text-lime-500" /> Nowy Nick
              </Label>
              <Input 
                type="text" 
              ...
              />
              <p className="text-[11px] text-zinc-600 ml-2 italic">Twój nick będzie widoczny dla innych użytkowników w rankingu i na czacie.</p>
            </div>
            ...
            <div className="pt-4">
              <Button className="w-full bg-lime-600 hover:bg-lime-700 text-white font-black h-16 rounded-2xl gap-3 shadow-xl shadow-lime-900/20 text-lg transition-transform hover:scale-[1.02] active:scale-[0.98]">
                <CheckCircle2 size={22} /> Zapisz Nowy Nick
              </Button>
