...
import { 
  ...
  MessageSquare, LogOut, Lock, ShieldCheck, ArrowLeft 
} from "lucide-react";
      ...
      <main className="flex-grow p-12 overflow-y-auto">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex items-center gap-6 mb-10 bg-zinc-900/20 p-6 rounded-3xl border border-zinc-800/50">
            ...
            <div>
              <h1 className="text-3xl font-black text-white italic tracking-tight">Zmiana Hasła</h1>
              <p className="text-zinc-500 text-sm font-medium">Zadbaj o bezpieczeństwo swojego konta BugWise.</p>
            </div>
          </div>
          ...
          <div className="mt-8 p-6 bg-lime-900/10 border border-lime-500/20 rounded-2xl">
            <p className="text-xs text-lime-500/80 leading-relaxed text-center italic">
              Wskazówka: Silne hasło powinno zawierać duże i małe litery, cyfry oraz znaki specjalne.
            </p>
          </div>
